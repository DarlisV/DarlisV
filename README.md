# 🤘🏾 Hi, I'm Darlis Valenzuela

🎓 Software Engineering Student.  
💻 Passionate about programming, web development.       
🛠️ Full Stack Developer | Self-employed & building my own solutions. 
...
|------------------|---------------------------------------------------------|--------------------------|
| Work Tracker     | App to manage services and track orders in real-time   | Python, Flask, JavaScript |
| Personal Website | My portfolio site (in progress)                        | HTML, CSS, React          |
